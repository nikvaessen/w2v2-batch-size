...
# read data
#df = read.csv("ft10min_over_time.fixed.csv")
df = read.csv("ft100h_over_time.fixed.csv")

# output file
#fn = "ft10min_over_time.pdf"
fn = "ft100h_over_time.pdf"

# title of plot
#title_label = "fine-tuning on 10 minutes of labeled data"
title_label = "fine-tuning on 100h of labeled data"
